...
const handleSend = async () => {
  ...
  if (selectedMode.value === 'lingseek') {
    // 智能模式：直接跳转到任务流程图页面（三列布局）
    console.log('跳转到智能任务页面')
...
.mode-selector {
  ...
  .mode-btn {
    ...
    box-shadow: 0 2px 4px rgba(255, 159, 67, 0.04);
...
// 智能模式输入框外发光“呼吸”动画（浅橙色，颜色不变，仅强弱变化）
@keyframes lingseek-breath {
  0%, 100% {
    box-shadow:
      0 0 0 2px rgba(255, 159, 67, 0.12),
      0 0 24px 10px rgba(255, 159, 67, 0.14);
  }
  50% {
    box-shadow:
      0 0 0 3px rgba(255, 159, 67, 0.22),
      0 0 44px 18px rgba(255, 159, 67, 0.22);
  }
}
...
@keyframes lingseek-breath-strong {
  0%, 100% {
    box-shadow:
      0 0 0 3px rgba(255, 159, 67, 0.20),
      0 0 36px 14px rgba(255, 159, 67, 0.24);
  }
  50% {
    box-shadow:
      0 0 0 4px rgba(255, 159, 67, 0.30),
      0 0 60px 24px rgba(255, 159, 67, 0.30);
  }
}
...
.input-section {
  ...
  .input-wrapper {
    ...
    padding: 16px 20px;
    transition: all 0.3s ease;
    box-shadow: 0 4px 16px rgba(255, 159, 67, 0.06);
    position: relative;
    z-index: 1;
    ...
    &.lingseek-glow {
      ...
      box-shadow:
        0 0 0 2px rgba(255, 159, 67, 0.12),
        0 0 16px 6px rgba(255, 159, 67, 0.14);
    ...
    &:focus-within {
      border-color: #ff9f43;
      box-shadow: 0 6px 24px rgba(255, 159, 67, 0.15);
      transform: translateY(-2px);
    }
      ...
      .footer-left {
        ...
        gap: 10px;
          ...
          .dropdown-menu {
            ...
            border: 1px solid #ffe0b2;
            border-radius: 12px;
            box-shadow: 0 10px 32px rgba(255, 159, 67, 0.15);
            min-width: 220px;
            z-index: 1000;
            max-height: 320px;
            overflow: hidden;
            ...
            .dropdown-footer {
              ...
              .selected-info {
                ...
                .selected-count {
                  ...
                  font-weight: 600;
                  padding: 4px 12px;
                  background: linear-gradient(135deg, #fff3e0 0%, #fffbf7 100%);
                  border-radius: 12px;
